...
if i == solution(P):
    print "Check 2: passed - Σωστή ελάχιστη τιμή"
else:
    print "Check 2: FAILED - Λάθος ελάχιστη τιμή"

for j in range(1, 10):
    L = random.sample(range(1,1000), 100)
    i = solution(L)
    if i == min(L):
        print "Check",j+2,": passed - Σωστή ελάχιστη τιμή"
    else:
        print "Check",j+2,": FAILED - Λάθος ελάχιστη τιμή"
        sys.exit()
